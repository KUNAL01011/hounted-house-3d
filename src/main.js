...
const wallColorTexture = textureLoader.load(
  "./static/wall/textures/castle_brick_broken_06_diff_1k.webp"
);
const wallARMTexture = textureLoader.load(
  "./static/wall/textures/castle_brick_broken_06_arm_1k.webp"
);
const wallNormalTexture = textureLoader.load(
  "./static/wall/textures/castle_brick_broken_06_nor_gl_1k.webp"
);
...
const tick = () => {
  ...
  const elapsedTime = timer.getElapsed();
    ...
    ghost2.position.y = Math.sin(ghost2Angle) * Math.sin(ghost2Angle * 2.34) * Math.sin(ghost1Angle *  3.45);

    const ghost3Angle = - elapsedTime * 0.23
    ghost3.position.x = Math.cos(ghost3Angle) * 6;
    ghost3.position.z = Math.sin(ghost3Angle) * 6;
    ghost3.position.y = Math.sin(ghost3Angle) * Math.sin(ghost3Angle * 2.34) * Math.sin(ghost1Angle *  3.45);
